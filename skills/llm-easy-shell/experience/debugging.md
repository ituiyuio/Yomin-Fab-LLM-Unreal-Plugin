# LLMEasyShell Debugging Guide

> 基于 2026-04-19 实战经验凝练：两个 bug 的根因分析和修复模式
...
echo 'python test_apply test' | nc 127.0.0.1 15151
...
**调试发现**：
- CLI 的 `echo 'python X Y' | llm-shell.exe` 方式对某些命令返回 "Unknown command: python"
