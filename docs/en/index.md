...
<section class="shell-section">
  ...
  <div class="shell-grid">
    <a class="shell-card" href="/en/llm-easy-shell/">
    ...
    <a class="shell-card" href="/en/llm-easy-shell-lite/">
      <div class="shell-card-icon">🔍</div>
